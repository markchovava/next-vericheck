...
export default function PepSourceList() {
  ...
  return (
    ...
    <main className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          {datasets.map((dataset) => (
            ...
            >
              <h2 className="text-xl text-gray-300 font-semibold mb-2 truncate">
                {dataset.title}
              </h2>
    ...
    <section className="max-w-6xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
      <article
        className="text-white rounded-lg p-6 acrylic-blur"
        tabIndex={0}
      ...
      <article
        className="bg-primary text-white rounded-lg p-6 acrylic-blur"
        tabIndex={0}
